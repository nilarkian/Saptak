...
is_note: true
title: Prompt library swipefile
tags:
  - swipefile
  - AI
  - prompt
...
# 2. Community Prompt Discovery Platforms

*Best for stealing practical workflows fast ⚡*
...
# 3. Prompt Engineering & Educational Resources

*Best for understanding why prompts work.*
...
| -------------------------- | ----------------------------- |
| Role prompting             | Controls style + domain       |
| XML / structured prompting | Stabilizes outputs            |
| Few-shot examples          | Pattern anchoring             |
| Decomposition              | Better reasoning              |
| Reflection loops           | Improves reliability          |
| Evaluation prompts         | Self-checking systems         |
| Context layering           | Better large-context handling |

---

# 4. Specialized Prompt Libraries
...
*Commercialized prompt ecosystems.*
...
# 6. Meta / Transparency / Debugging Resources

*Advanced prompt archaeology 🧠*
